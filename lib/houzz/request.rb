module Houzz
  ...
  # = Request
  #
  # A basic wrapper around GET requests to the Houzz JSON API
  #
  class Request
    ...
    def initialize(resource_path, parameters = {})
      ...
      @token = parameters.delete(:access_token) || Houzz.credentials[:access_token]
      @secret = parameters.delete(:access_secret) || Houzz.credentials[:access_secret]
      ...
      parameters = parameters.merge(:api_key => Houzz.api_key) unless secure?
